    ...
    return (
        <div className="mb-2 w-full flex flex-col items-center">
            <div className="relative">
                ...
                <button>
                    <div className="absolute bottom-3 end-2 flex p-0.5 rounded-md bg-gray-200">
                        <svg className="stroke-gray-700" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
