export default function ChatResponse({ text }) {
        ...
        <div className="mb-3 flex justify-center flex-nowrap">
            <div className="bg-black h-8 w-8 rounded-full flex justify-center items-center">
                <svg className="stroke-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
